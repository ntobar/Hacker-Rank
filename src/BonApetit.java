...
public class BonApetit {
  ...
  /**
   * "If the bill is fairly split, print Bon Appetit ; otherwise, print the amount of money that
   * Brian must refund to Anna." - Hacker Rank
   *
  ...
  public static void main(String[] args) {
    ...
    System.out.println(bon.bonApetit(4, 1, costs, 12));
